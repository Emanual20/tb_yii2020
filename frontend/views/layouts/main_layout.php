       ...
       <li>
         ...
         <li>
           <a class="accordion-toggle" href="">
             ...
             <li>
               <a href="<?php echo Url::to(['site/selfwork2']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 孙一丁</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['site/selfwork3']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 董佳霖</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['site/selfwork4']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 翟江天</a>
             </li>
             <li>
