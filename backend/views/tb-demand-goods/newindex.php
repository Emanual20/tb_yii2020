													...
													<form action = "/tb_yii2020/tb_yii2020/backend/web/index.php?r=tb-demand-goods%2Fadd" method="post" name="addform">
                                                        ...
                                                        <div class="row">
															...
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																	<label>需求类型</label>
																	<input id="addtype" type="text" name = "DType" class="form-control" placeholder="填写需求类型">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>需求数量</label>
																	<input id="addnum" type="text" name = "DNum" class="form-control" placeholder="填写需求数量">
																</div>
                                                            </div>
                                                            <div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>报价</label>
																	<input id="addprice" type="text" name = "DPrice" class="form-control" placeholder="填写报价">
																</div>
                                                            </div>
                                                            <div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>详细描述</label>
																	<input id="adddetail" type="text" name = "DDetail" class="form-control" placeholder="可以进行详细描述">
																</div>
                                                            </div>
                                                            <div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>地址</label>
																	<input id="addaddr" type="text" name = "DAddress" class="form-control" placeholder="详细地址">
																</div>
															</div>
														</div>
													</form>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											<thead>
												<tr>
                                                <th>UserID</th>
													<th style="width: 10%">DemandID</th>
													<th style="width: 10%">DemandType</th>
